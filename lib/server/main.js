(function() {
  var Bridge, ClientConnection, ClientSideFiles, CodeDepot, Fiber, Hosts, RichBridge, app, async, clientFiles, connections, depot, echo, events, express, fs, hosts, server, sockjs, vm, _, _ref, _ref1,
